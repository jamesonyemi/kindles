    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1 box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
            ...
            <div class="card-footer no-border">
                <p class="float-sm-left text-xs-center"><a href="index.php" class="card-link">Login</a></p>
                <p class="float-sm-right text-xs-center">New to Robust ? <a href="register.php" class="card-link">Create Account</a></p>
            </div>
        </div>
    </div>
</section>
     ...
     <!-- ////////////////////////////////////////////////////////////////////////////-->
<?php include 'layout/login_footer.php'; ?> 